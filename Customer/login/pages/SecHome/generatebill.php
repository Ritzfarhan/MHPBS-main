...
if ($billpaymentStatus == 1) {
  ...
  $query = "insert into bookings (bookingID,paymentID,lastname,email,phone,checkin,checkout,roomtype,status) values ('$bookingID','$billpaymentInvoiceNo','$billTo','$billEmail','$billPhone','$billName','$billDescription','$billSplitPaymentArgs',0)";
